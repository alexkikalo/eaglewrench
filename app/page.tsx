  ...
  return (
    <div>
        ...
        <div className="mx-auto max-w-6xl px-4 py-16 md:py-24 grid md:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <p className="mt-6 text-lg text-garage-steel max-w-prose">
              ...
              wipers, and the rest of the list. Pick your vehicle once. Every bay reads it. Learn
              the sequence, see the parts, and excel at the work. Educational only. No account
              required.
            </p>
      ...
      <section className="mx-auto max-w-6xl px-4 py-16 grid md:grid-cols-3 gap-6">
        {[
          ["01", "Pick the vehicle", "Year, make, model, engine — saved once. Oil specs today. Tire sizes and wiper lengths when those bays land."],
      ...
      <section id="waitlist" className="mx-auto max-w-6xl px-4 pb-20">
        <div className="steel-panel p-6 md:p-10 relative">
          ...
          <p className="mt-2 mb-6 text-garage-steel max-w-prose">
            Next bays: tire rotation, wiper replacement, and the rest of the driveway list. The oil
            change demo is already live — no login.
          </p>
          <WaitlistForm />
        </div>
      </section>
